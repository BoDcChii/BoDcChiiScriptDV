...
Sidebar.Parent = MainFrame; Sidebar.Size = UDim2.new(0, 75, 1, -40); Sidebar.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
local PageContainer = Instance.new("Frame")
PageContainer.Parent = MainFrame; PageContainer.Position = UDim2.new(0, 80, 0, 40); PageContainer.Size = UDim2.new(1, -90, 1, -80); PageContainer.BackgroundTransparency = 1
