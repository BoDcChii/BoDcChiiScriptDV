-- [[ BoDcChii Project v0.8 - Real Smooth Drag Fix 🎸 ]] --
...
-- --- FUNGSI DRAG KHUSUS HP/PC (ANTI-LAG) ---
...
EnableDrag(OpenIcon) -- PAKSA BISA DIGESER

-- --- 3. MAIN FRAME (MENU BAR) ---
local MainFrame = Instance.new("Frame")
MainFrame.Parent = ScreenGui; MainFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 20); MainFrame.Position = UDim2.new(0.5, -140, 0.3, 0); MainFrame.Size = UDim2.new(0, 280, 0, 300); MainFrame.Visible = false; MainFrame.ZIndex = 5; MainFrame.Active = true -- Penting buat Drag
local MainCorner = Instance.new("UICorner"); MainCorner.CornerRadius = UDim.new(0, 10); MainCorner.Parent = MainFrame

EnableDrag(MainFrame) -- PAKSA BISA DIGESER
